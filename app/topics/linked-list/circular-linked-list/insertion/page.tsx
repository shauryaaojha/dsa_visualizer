...
export default function Hub() {
  ...
  return (
    <TopicHub
      path="/topics/linked-list/circular-linked-list/insertion"
      icon={group.icon}
      eyebrow="CIRCULAR LINKED LIST · INSERTION"
      title={group.title}
      blurb={group.blurb}
      ...
      cards={(group.children ?? []).map((l) => ({
        ...
        blurb: l.blurb,
        icon: l.icon,
        href: `/topics/linked-list/circular-linked-list/insertion/${l.slug}`,
